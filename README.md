...
| `node_id_check`      |  Работает| Адаптирован: теперь ищет отсутствие `node_id` при наличии других признаков контента. И никогда не находит. Проблема в недостаточной выборке данных |
...
| `node_id_check`    | Адаптирован, не находит конфликты с отсутствием node_id и присутствием описания контента.| - kinda done
